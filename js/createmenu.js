...
function xuat_allsp()
{
	var s = `<div style="font-size: 22px;margin-top: 14px;margin-bottom: 9px;margin-left: 14px;">Nổi bật</div><div style="right:45px; position:absolute; bottom:0px;"><a href="index.html?all&page=1" style="color:white; text-decoration:none"><h2>Xem tất cả sản phẩm ❯❯</h2></a></div>`;
	var dem =0; 
