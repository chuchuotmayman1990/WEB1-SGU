...
sp[8] = new sanpham("NV PL TGM","The Witcher 3: Wild Hunt - Game of the Year Edition","369.000","./img/content/tw3/tw3-0.jpg");
...
sp[16] = new sanpham("NV PL TGM","Fallout 4: Game of the Year Edition","480.000","./img/content/fo4/fo4-0.jpg");
sp[17] = new sanpham("NV PL TGM","The Elder Scrolls V: Skyrim Special Edition","900.000","./img/content/tesv/tesv-0.jpg");
sp[18] = new sanpham("NV PL TGM KD","Dying Light Enhanced Edition","549.000","./img/content/dl/dl-0.jpg");
sp[19] = new sanpham("NV KD","RESIDENT EVIL 7 biohazard / BIOHAZARD 7 resident evil","398.000","./img/content/re7/re7-0.jpg");
sp[20] = new sanpham("TT","NBA 2K19","984.000","./img/content/nba19/nba19-0.jpg");